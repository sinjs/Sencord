...
// @ts-expect-error
export const getSocketIO = /* #__PURE__*/ makeLazy(() => import("https://unpkg.com/socket.io@4.8.1/client-dist/socket.io.esm.min.js"));

// @ts-expect-error
export const getKatex = /* #__PURE__*/ makeLazy(async () => (await import("https://assets.nigga.church/git/sencord/katex/dist/katex.mjs")).default);
