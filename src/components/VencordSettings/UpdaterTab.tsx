...
function Updater() {
    ...
    return (
        <SettingsTab title="Sencord Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Sencord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Sencord automatically updates"
