...
function SettingsComponent(props: { setValue(v: any): void; }) {
    const [fileUploader, setFileUploader] = useState(settings.store.fileUploader || "F22");
    ...
    return (
        <Flex flexDirection="column">
            ...
            <Forms.FormSection title="Upload Limit Bypass">
                ...
                <Select
                    options={[
                        { label: "F22 (Up to 5 GB)", value: "F22" },
...
async function uploadFile(file: File, channelId: string) {
    ...
    switch (uploader) {
        case "F22":
            await uploadFileToF22(file, channelId);
            break;
        case "GoFile":
...
export default definePlugin({
    ...
    authors: [Devs.ScattrdBlade, Devs.TechFun],
    settings,
